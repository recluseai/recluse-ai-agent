...
from config import TWITTER_OAUTH_CONSUMER_KEY, TWITTER_OAUTH_CONSUMER_SECRET, TWITTER_AUTH_ACCESS_TOKEN, TWITTER_AUTH_ACCESS_TOKEN_SECRET
import tweepy
...
public_tweets = api.get_user(screen_name="moboluwade")
